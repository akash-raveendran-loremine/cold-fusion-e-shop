...
<body>
    <nav class="navbar navbar-dark">
        <div class="container-fluid">
            <div class="row w-100">
                <div class="col ms-5">
                    <a href="#" class="nav-link text-light fw-bold fs-1">E shoP</a>
                </div>
                <div class="col d-flex justify-content-end align-items-center">
                    <cfoutput>
                        ...
                        <a href="#buildURL('main.cart')#" class="nav-link text-light"> <i class="bi bi-cart4"></i>
                            Cart</a>
                        <a href="#buildURL('main.orders')#" class="nav-link text-light"><i class="bi bi-truck"></i> Orders</a>
    ...
    <footer id="footer" class="bg-dark px-5 pt-5">
        ...
        <p class="text-center text-info pb-2">Created By Akash</p>
    </footer>
</body>
